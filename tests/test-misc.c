...
test_yaml_news_freeform_lists (void)
{
	...
	static const gchar *expected_xml_releases_data =
	    ...
	    "        </ul>\n"
	    "      </description>\n"
	    "      <url>https://example.com/releases/1.0</url>\n"
	    "    </release>\n"
	    "  </releases>";
...
test_news_yaml_multiline_paragraph (void)
{
	...
	static const gchar *expected_xml_releases_data =
	    ...
	    "    <release type=\"stable\" version=\"1.0\" date=\"2026-01-01T00:00:00Z\">\n"
	    "      <description>\n"
	    "        <p>A paragraph that is written on two lines.</p>\n"
	    "        <ul>\n"
...
test_readwrite_text_news (void)
{
	...
	static const gchar *expected_xml_releases_data =
	    ...
	    "        <p>Not a heading: this line is not a listing and does not follow an empty "
	    "line.</p>\n"
	    "      </description>\n"
	    "    </release>\n"
	    "  </releases>";
