...
test_readwrite_text_news (void)
{
	static const gchar *text_news_data =
	    ...
	    " * CVE references like [CVE-2026-41651](https://db.gcve.eu/vuln/CVE-2026-41651) are "
	    "auto-detected\n"
	    ...
	    "[CVE-2020-0001](https://db.gcve.eu/vuln/CVE-2020-0001)\n"
	    "\n"
	    "Resolved Issues:\n"
	    " * CVE-2020-0001\n"
	...
	static const gchar *expected_xml_releases_data =
	    ...
	    "        <issue type=\"cve\">CVE-2026-41651</issue>\n"
	...
	static const gchar *expected_generated_news_txt =
	    ...
	    "Resolved Issues:\n"
	    " * #12345: https://example.com/bugzilla/12345\n"
	    " * CVE-2026-41651: https://db.gcve.eu/vuln/GCVE-0-2026-41651\n"
	    ...
	    " * CVE-2020-0001: https://db.gcve.eu/vuln/GCVE-0-2020-0001\n"
	    " * #99: https://example.com/bugzilla/99\n"
	    "\n"
	    "Version 0.12.6\n"
	    "~~~~~~~~~~~~~~\n"
