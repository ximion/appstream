...
namespace Polkit {
	...
	public class Authority : GLib.Object, GLib.AsyncInitable, GLib.Initable {
		...
		public bool authentication_agent_response_sync (string cookie, Polkit.Identity identity, GLib.Cancellable? cancellable) throws GLib.Error;
		...
		public Polkit.AuthorizationResult check_authorization_sync (Polkit.Subject subject, string action_id, Polkit.Details? details, Polkit.CheckAuthorizationFlags flags, GLib.Cancellable? cancellable) throws GLib.Error;
		...
		public static Polkit.Authority get_sync (GLib.Cancellable? cancellable) throws GLib.Error;
		...
		public bool register_authentication_agent_sync (Polkit.Subject subject, string locale, string object_path, GLib.Cancellable? cancellable) throws GLib.Error;
		...
		public bool register_authentication_agent_with_options_sync (Polkit.Subject subject, string locale, string object_path, GLib.Variant? options, GLib.Cancellable? cancellable) throws GLib.Error;
		public async bool revoke_temporary_authorization_by_id (string id, GLib.Cancellable? cancellable) throws GLib.Error;
		public bool revoke_temporary_authorization_by_id_sync (string id, GLib.Cancellable? cancellable) throws GLib.Error;
		public async bool revoke_temporary_authorizations (Polkit.Subject subject, GLib.Cancellable? cancellable) throws GLib.Error;
		public bool revoke_temporary_authorizations_sync (Polkit.Subject subject, GLib.Cancellable? cancellable) throws GLib.Error;
		...
		public bool unregister_authentication_agent_sync (Polkit.Subject subject, string object_path, GLib.Cancellable? cancellable) throws GLib.Error;
	...
	public class Permission : GLib.Permission, GLib.AsyncInitable, GLib.Initable {
		[CCode (cname = "polkit_permission_new")]
		...
		[CCode (has_construct_function = false, type = "GPermission*")]
		public Permission.sync (string action_id, Polkit.Subject? subject, GLib.Cancellable? cancellable) throws GLib.Error;
	...
	public class SystemBusName : GLib.Object, Polkit.Subject {
		...
		public Polkit.Subject get_process_sync (GLib.Cancellable? cancellable) throws GLib.Error;
	...
	public class UnixSession : GLib.Object, GLib.AsyncInitable, GLib.Initable, Polkit.Subject {
		...
		public static Polkit.Subject new_for_process_sync (int pid, GLib.Cancellable? cancellable) throws GLib.Error;
	...
	public interface Subject : GLib.Object {
		...
		public abstract bool exists_sync (GLib.Cancellable? cancellable) throws GLib.Error;
